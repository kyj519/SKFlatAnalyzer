...
double Event::GetTriggerLumi(TString trig)
{
  if (j_DataEra == "2016preVFP")
  {
    if (trig == "Full")
      ...
      return 163.439249664;
    else if (trig == "HLT_Photon120_v")
      return 338.327429849;
  ...
  else if (j_DataEra == "2017")
  {
    ...
    else if (trig == "HLT_Mu8_v")
    {
      ...
      return 575.585018236;
    else if (trig == "HLT_Mu27_v")
      return 184.843129035;
    else if (trig == "HLT_Mu50_v")
      return 41477.877400009;
    else if (trig == "HLT_Mu55_v")
      return 27121.940558082;
      ...
      return 101.406554985;
    else if (trig == "HLT_Photon90_v")
      return 122.130341981;
    else if (trig == "HLT_Photon120_v")
      return 490.132351457;
    else if (trig == "HLT_Photon150_v")
      return 689.862207927;
    else if (trig == "HLT_Photon175_v")
      return 1245.403311711;
    else if (trig == "HLT_Photon200_v")
      return 41477.877400009;
    else if (trig == "HLT_IsoMu24_v")
      return 37997.004705584;
    else if (trig == "HLT_IsoMu27_v")
      return 41477.877400009;
  ...
  else if (j_DataEra == "2018")
  {
    if (trig == "Full")
      ...
      return 117.946263489;
    else if (trig == "HLT_Photon90_v")
      return 117.622232475;
    else if (trig == "HLT_Photon120_v")
      return 470.863308303;
    else if (trig == "HLT_Photon150_v")
      return 478.335294777;
    else if (trig == "HLT_Photon175_v")
      return 952.895805882;
    else if (trig == "HLT_Photon200_v")
      return 59827.879502925;
    else if (trig == "HLT_IsoMu24_v")
      return 59819.714470919;
    else if (trig == "HLT_IsoMu27_v")
      return 59827.879502925;
    else if (trig == "HLT_IsoMu30_v")
      return 59827.879502925;
      ...
      return 3008.003592622;
    else if (trig == "HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_v")
      return 3135.331113947;
    else if (trig == "HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v")
      return 59827.879502925;
    else if (trig == "HLT_Mu19_TrkIsoVVL_Mu9_TrkIsoVVL_DZ_Mass8_v")
      return 59827.879502925;
...
{
  if (type == "PF")
    j_METVector_pf.SetPtEtaPhiE(pt, 0, phi, pt);
  else if (type == "PUPPI")
    j_METVector_puppi.SetPtEtaPhiE(pt, 0, phi, pt);
  else
  {
