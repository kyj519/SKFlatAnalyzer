...
mc_list = {
    ...
    "SingleTop_tW_antitop_NoFullyHad":[30,30], 
    "SingleTop_tW_top_NoFullyHad":[30,30], 
    "DYJets_MG":[50,50], 
    "WJets_MG":[50,50],
...
if args.mc == True:
    for mc in mc_list:
        operation =  f"nohup SKFlat.py -a Vcb_Tagging_RF_DL -i {mc} -n {mc_list[mc][1]} -e {args.era} --userflag Run{args.channel} &"
